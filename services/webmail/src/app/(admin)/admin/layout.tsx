        ...
        <div>
          ...
          <div className="flex items-center gap-3 px-2 mb-6">
            ...
            <div>
              ...
              <div className="text-[10px] text-emerald-400 uppercase tracking-wider font-mono">Management Console</div>
            </div>
          </div>
          ...
          <nav className="space-y-1 text-sm font-medium">
            ...
            <Link
              ...
              className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-slate-400 hover:text-slate-200 hover:bg-slate-800/50 transition-colors"
            >
              <span>&#128737;</span> Audit Logs & Preflight
            </Link>
          </nav>
        </div>
